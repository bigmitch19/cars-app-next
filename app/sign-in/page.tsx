...
export default function Home() {
	...
	return (
		<>
			<div className="bg-purple-900 absolute top-0 left-0 bg-gradient-to-b from-gray-900 via-gray-900 to-purple-800 bottom-0 leading-5 w-full overflow-hidden h-screen"></div>
